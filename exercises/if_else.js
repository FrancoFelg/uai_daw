...
if(random>=0.5) alert("Greater than 0.5")
...
if(age >= 12 && age < 19) alert("Adolescente")
if(age >= 20 && age < 30) alert("Joven")
if(age >= 30 && age < 60) alert("Adulto")
if(age >= 60 && age < 75) alert("Adulto mayor")
